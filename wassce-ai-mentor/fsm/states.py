...
VALID_TRANSITIONS: dict[FSMState, set[FSMState]] = {
    FSMState.GREETING:          {FSMState.SUBJECT_SELECTION, FSMState.GREETING},
    FSMState.SUBJECT_SELECTION: {FSMState.QUESTION_DELIVERY, FSMState.SUBJECT_SELECTION, FSMState.GREETING},
    ...
    FSMState.EXPLANATION:       {FSMState.QUESTION_DELIVERY, FSMState.SUBJECT_SELECTION, FSMState.SESSION_SUMMARY, FSMState.GREETING},
...
GLOBAL_COMMANDS = {"STOP", "QUIT", "HELP", "MENU", "EXIT"}
