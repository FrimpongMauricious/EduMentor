...
class FSMState(str, Enum):
    ...
    QUESTION_TYPE_SELECTION = "QUESTION_TYPE_SELECTION"  # WhatsApp only: MCQ vs Theory (only when the subject has both)
...
VALID_TRANSITIONS: dict[FSMState, set[FSMState]] = {
    FSMState.GREETING:                {FSMState.SUBJECT_SELECTION, FSMState.NAME_ENTRY, FSMState.GREETING, FSMState.TEST_IN_PROGRESS},
    FSMState.NAME_ENTRY:              {FSMState.SUBJECT_SELECTION, FSMState.NAME_ENTRY},
    FSMState.SUBJECT_SELECTION:       {FSMState.QUESTION_DELIVERY, FSMState.SUBJECT_SELECTION, FSMState.GREETING, FSMState.TEST_IN_PROGRESS, FSMState.QUESTION_TYPE_SELECTION},
    FSMState.QUESTION_TYPE_SELECTION: {FSMState.QUESTION_DELIVERY, FSMState.SUBJECT_SELECTION, FSMState.GREETING, FSMState.QUESTION_TYPE_SELECTION},
